...
if __name__ == "__main__":
    ...
    try:
        ...
        sql = "select index_name, trade_date,close from dc_index_market a  where a.trade_date >= '20240924' and a.index_name in ('上证指数','沪深300','创业板','北证50','科创50','中证1000') order by a.trade_date;"
