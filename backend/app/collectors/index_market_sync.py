...
分组（v2.7 六分类，按指数实际体现的观察内容，每组回答一个风向问题）：
- 市场基准 5：上证指数 / 深证成指 / 中证全指 / 深证100 / 北证50
- 市值风格 5：上证50(超大盘) / 沪深300(大盘) / 中证500(中盘) / 中证1000(小盘) / 中证2000(微盘)
- 科技成长 5：科创50 / 科创100 / 创业板指 / 创业板50 / 国证芯片
- 情绪温度 1：证券公司
- 股息防守 4：中证红利 / 中证转债 / 中证银行 / 中证白酒
- 政策周期 1：中证全指房地产
分组/角色说明由 INDEX_META 随行写入 index_group / group_desc（2026-09-13 v2.3 新增列，v2.7 改六分类），供前端分组与语义展示。
...
# 六分类（2026-09-13 v2.7，用户定稿）：按"指数实际想体现的观察内容"分组，每组回答一个风向问题——
# 市场基准=大势位置；市值风格=大小盘剪刀差；科技成长=风偏进攻；情绪温度=交易热度；股息防守=避险去向；政策周期=政策预期。
