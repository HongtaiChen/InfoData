...
分组（v2.5 三分类：宽基=基准仪表盘，进攻=高β/成长/热点，防守=红利/债性/权重避风港）：
- 宽基 10：上证指数 / 上证50 / 沪深300 / 中证全指 / 中证500 / 中证1000 / 中证2000 / 深证成指 / 深证100 / 北证50
- 进攻 8：科创50 / 科创100 / 创业板指 / 创业板50 / 国证芯片 / 证券公司 / 中证白酒 / 中证全指房地产
- 防守 3：中证红利 / 中证转债 / 中证银行
分组/角色说明由 INDEX_META 随行写入 index_group / group_desc（2026-09-13 v2.3 新增列，v2.5 改三分类），供前端分组与语义展示。
...
# 三分类（2026-09-13 v2.5，用户定稿）：宽基=市场基准仪表盘；进攻=高β/成长/热点弹性；防守=红利/债性/权重避风港。
