...
# 中证指数官网覆盖（沪市 / 中证 / 北证系列），含成交额
CSINDEX_CODES = {"000001", "000016", "000300", "000688", "000698", "000852", "000905", "899050", "931775"}
# 深证系列（国证指数），成交额取自 akshare index_hist_cni
CNINDEX_CODES = {"399001", "399006", "399330", "399673"}
